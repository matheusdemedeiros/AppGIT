    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <View style={styles.buttons}>
          ...
          <TouchableOpacity style={styles.buttonAdd}  onPress={() => this.props.navigation.navigate('Cadastro',{resultado: this.state.resutadoSoma})}>
